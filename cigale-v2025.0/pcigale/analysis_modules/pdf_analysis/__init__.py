...
class PdfAnalysis(AnalysisModule):
    ...
    parameters = {
        "variables": (
            "cigale_string_list()",
            "List of the physical properties to analyse. The analysis can be "
            "done on the log of the value appending _log. To accelerate the "
            "computation, properties of no interest to the study should be "
            "removed. Note: they will still be provided for the best fit.",
            None,
        ),
        "bands": (
            "cigale_string_list()",
