...
The idea behind the repository is simple. You have working CIGALE v2022.1 distribution (it has to be installed within dedicated conda/virtual environment!). Download my repo. Merge directories.
